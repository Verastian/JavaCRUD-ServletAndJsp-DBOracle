...
<body>
	...
	<!-- <form action="agregar-producto" method="POST">
		<label for="nombre_producto">Nombre Producto</label> <input type="text" name="nombre_producto"
		id="nombre_producto" /> <label for="precio">Precio</label> <input type="number" name="precio"
		id="precio" /> <label for="descripcion">Descripcion</label> <input type="text" name="descripcion"
		id="descripcion" /> <label for="categorias">Categoria</label> <select name="categorias"
		id="categorias">
		<c:forEach items="${categorias}" var="cat">
			...
			<div class="container">
		<h1 class="text_color">Agregar Productos</h1>
		<form action="agregar-producto" method="POST">
			<div class="modal-body">
				<div class="form-group" id="nombre_producto">
					<input type="text" name="nombre_producto" id="nombre_producto"
						class="form-control pl-5" placeholder="Nombre del Producto">
				</div>
				<div class="form-group" id="precio">
					<input type="number" id="precio" class="form-control my-4 pl-5"
